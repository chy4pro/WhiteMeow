      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: "waitingRoom",
            name: "waitingRoom",
            component: () => import('@/views/chat/game/textAdventure/waitingRoom.vue'),
            props: true,
          ...
          },
          {
            path: "hasRoom",
            name: "hasRoom",
            component: () => import('@/views/chat/game/textAdventure/hasRoom.vue'),
            props: true,
            meta: { title: "输入房间号-文字冒险游戏" },
          },
          {
            path: "textAdventure",
            name: "textAdventure",
