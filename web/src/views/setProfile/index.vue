        ...
        <div class="flex flex-row-start wh-full">
          ...
          ">
            <div class="mt-9rem mx-4rem">
              ...
              <div class="text-1.6rem font-600 mb-2.4rem">个人档案</div>
              
              <a-input-password class="normal-input-wrap mb-1.6rem">
                <template #suffix>
              ...
              <div>
                  ...
                  <a-button class="w-full bg-black color-white h-5.6rem">确认</a-button>
                  <div>
                    <a-checkbox>
